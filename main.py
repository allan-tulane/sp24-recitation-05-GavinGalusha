...
def compare_sort(sizes=[100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]):
	"""
	...
	qsort_fixed_pivot = lambda a: qsort(a, lambda b: b[0])
	qsort_random_pivot = lambda a: qsort(a, lambda b: random.choice(b))
